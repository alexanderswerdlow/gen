...
if __name__ == '__main__':
    ...
    # save invalid ids
    # np.save('data/objaverse_meta/invalid_ids.npy', invalid_ids)
    # print(invalid_ids)
    # print("Total invalid len ", len(invalid_ids))

    # move invalid views
    invalid_ids = np.load('data/objaverse_meta/all_invalid.npy')
    invalid_path = os.path.join(path, 'data/objaverse_meta/invalid')
